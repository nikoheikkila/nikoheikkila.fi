...
test('single blog post renders correctly', withBrowser, async (t, page) => {
  ...
  await Promise.all([page.waitForNavigation(), page.click('.post-title:first-child > a')])
 ...
 */
test('theme switcher can switch between light and dark modes', withBrowser, async (t, page) => {
  await page.goto(baseURL)
